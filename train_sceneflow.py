...
parser.add_argument('--datapath', default=sys_root+"/SceneFlow/", help='data path')
...
parser.add_argument('--lrepochs', type=str, default="10,14,18,22,26:2", help='the epochs to decay lr: the downscale rate')
...
TrainImgLoader = DataLoader(train_dataset, args.batch_size, shuffle=True, pin_memory = True, num_workers=args.num_workers, drop_last=True)
TestImgLoader = DataLoader(test_dataset, args.test_batch_size, shuffle=False, pin_memory = True, num_workers=args.num_workers, drop_last=False)
